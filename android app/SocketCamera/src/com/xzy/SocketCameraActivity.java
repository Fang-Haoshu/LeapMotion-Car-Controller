...
public class SocketCameraActivity extends Activity implements SurfaceHolder.Callback,
	...
	/**服务器地址*/
	private String serverUrl="192.168.0.101";
	/**服务器端口*/
	...
	private static String address = "00:15:FF:F3:26:E0"; // <==要连接的蓝牙设备MAC地址
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Thread thr = new MyReceiveCommendThread(pUsername,serverUrl,serverPort);
        thr.start();
	...
	public void onStart()//重新启动的时候
	{
		...
		serverUrl=preParas.getString("ServerUrl", "10.189.163.49");
    ...
    /**转发命令线程*/
    class MyReceiveCommendThread extends Thread{
        private String username;
        private String ipname;
        private int port;
        ...
        public MyReceiveCommendThread(String username,String ipname,int port){
        ...
        public void run() {
            try{
                ...
                while(true) {
                    ...
                    Reader read = new InputStreamReader(insocket);
                    ...
                    try {
                        ...
                        Log.e(TAG, "ON my recv commend.outstream.",
                                e);
                    }
                    try {
